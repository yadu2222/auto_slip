...
//   // 定期一覧取得
//   static Future<List<Map<String, dynamic>>> searchRegulerList(int searchType, String searchData) async {
//     // db 接続
//     Database? db = await instance.database;
//     debugPrint("検索タイプ：$searchData");
//     switch (searchType) {
//       // 店舗名検索
//       case 0:
//         return await db!.rawQuery('''
...
//       where s.store_name like '%${searchData}%'
...
//           JOIN regulars AS r ON r.store_id = s.store_id
//           JOIN magazines AS m ON r.magazine_code = m.magazine_code
//           where r.magazine_code = '${searchData}'
...
//           JOIN regulars AS r ON r.store_id = s.store_id
//           JOIN magazines AS m ON r.magazine_code = m.magazine_code
//           where m.magazine_name like '%${searchData}%'
